...
use KadokWeb\Scrapbook\Adapters\Apc;
...
use KadokWeb\Scrapbook\Adapters\Redis;
use KadokWeb\Scrapbook\Adapters\SQL;
...
class StampedeProtectorTest extends AdapterTestCase
{
    ...
    protected function forkableAdapter(KeyValueStore $cache)
    {
        ...
        // https://gist.github.com/kadokweb/e5e856b27ddb68d7cf80
        ...
        // https://travis-ci.org/kadokweb/scrapbook/jobs/91360815
