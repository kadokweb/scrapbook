...
Simply add a dependency on kadokweb/scrapbook to your composer.json file
...
[KeyValueStore](https://docs.scrapbook.cash/master/class-KadokWeb.Scrapbook.KeyValueStore.html)
...
[Travis CI](https://travis-ci.org/kadokweb/scrapbook) using the official
