...
namespace KadokWeb\Scrapbook\Adapters\Collections;

use KadokWeb\Scrapbook\Adapters\Collections\Utils\PrefixKeys;
use KadokWeb\Scrapbook\Adapters\MemoryStore as Adapter;
