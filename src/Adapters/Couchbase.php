...
namespace KadokWeb\Scrapbook\Adapters;

use KadokWeb\Scrapbook\Adapters\Collections\Couchbase as Collection;
use KadokWeb\Scrapbook\Exception\InvalidKey;
use KadokWeb\Scrapbook\Exception\ServerUnhealthy;
